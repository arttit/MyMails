            ...
            <div class="nav-inner">
                ...
                <div class="pure-menu">
                    <ul class="pure-menu-list">
                        <li class="pure-menu-item pure-menu-selected"><a href="mail.php" class="pure-menu-link">Inbox <span class="email-count"></span></a></li>
                        ...
                        <li class="pure-menu-item"><a href="drafts.php" class="pure-menu-link">Drafts</a></li>
                        ...
                        if (isset($_SESSION['label-name-'.$i]) && isset($_SESSION['label-filter-'.$i])) {
                            echo '<li class="pure-menu-item folder" id="'.$_SESSION['label-name-'.$i].'"><a href="mail.php?labels='.$_SESSION['label-filter-'.$i].'" class="pure-menu-link"><span class="email-label-personal"></span>'.$_SESSION['label-name-'.$i].'</a></li>';
                        }} ?>
...
<div id="myModal" class="modal fade">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="#modalTimer" data-toggle="modal"><button type="button" id="timer" class="pure-button button-small">Timer <span id="time-icon" class="fas fa-stopwatch"></span></button></a>
    ...
    <div id="modalTimer" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form method="POST" class="pure-form" action="">
                        <div class="pure-control-group">
                            <h3 id="timer-real">to a real time</h3>
                            <input class="choice" value="real-time" id="choice1" type="checkbox" name="choice"/>
                            <h4 id="or-timer">or</h4>
                            <input id="choice2" value="countdown" class="choice" type="checkbox" name="choice"/>
                            <h3 id="timer-countdown">with a countdown</h3>
                        </div>
                        <p id="hint1">hh:mm</p>
                        <input type="time" style="display: none" id="input1" class="pure-input-1-2 input-timer" name="time-input"/>
                        <p id="hint2">mm:ss</p>
                        <input type="time" style="display: none" id="input2" class="pure-input-1-2 input-timer" name="search-input"/>
                </div>
                <div class="modal-footer modal-footer-right">
                    <button type="button" class="pure-button button-small" data-dismiss="modal">Close</button>
                    <a href="#modalTimezone" data-toggle="modal"><button type="button" id="submit-timer" class="pure-button button-small  pure-button-primary">Set timer</button></a>
                    </form>
                </div>
            </div>
        </div>
    </div>
    <div id="modalTimezone" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title">Timer :</h2>
                </div>
                <div class="modal-body">
                    <h3 id="txt-timezone">Email will be send in :</h3>
                    <div id="timezone"></div>
                </div>
                <div class="modal-footer modal-footer-right">
                    <button type="button" id="endTimer" class="pure-button button-small" data-dismiss="modal">Close</button>
                    <button type="button" id="submit-timer" class="pure-button button-small  pure-button-primary">Set timer</button>
                </div>
            </div>
        </div>
    </div>
